...
async function main() {
  ...
  const admin = await prisma.user.upsert({ where: { email: "admin@gorkhali.com" }, update: { password_hash: adminPw, role: UserRole.ADMIN, is_active: true, emailVerified: new Date() }, create: { name: "राजेश शर्मा", email: "admin@gorkhali.com", password_hash: adminPw, role: UserRole.ADMIN, is_active: true, emailVerified: new Date() } });
  const editor = await prisma.user.upsert({ where: { email: "editor@gorkhali.com" }, update: { password_hash: editorPw, role: UserRole.EDITOR, is_active: true, emailVerified: new Date() }, create: { name: "सुनिता पौडेल", email: "editor@gorkhali.com", password_hash: editorPw, role: UserRole.EDITOR, is_active: true, emailVerified: new Date() } });
  const a1 = await prisma.user.upsert({ where: { email: "author@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() }, create: { name: "कमल अधिकारी", email: "author@gorkhali.com", password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() } });
  const a2 = await prisma.user.upsert({ where: { email: "author2@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() }, create: { name: "प्रतिभा गुरुङ", email: "author2@gorkhali.com", password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() } });
  const a3 = await prisma.user.upsert({ where: { email: "author3@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() }, create: { name: "विनोद थापा", email: "author3@gorkhali.com", emailVerified: new Date(), password_hash: authorPw, role: UserRole.AUTHOR, is_active: true } });
  const a4 = await prisma.user.upsert({ where: { email: "author4@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() }, create: { name: "आस्था श्रेष्ठ", email: "author4@gorkhali.com", password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() } });
  const a5 = await prisma.user.upsert({ where: { email: "author5@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() }, create: { name: "रबिन्द्र बुढाथोकी", email: "author5@gorkhali.com", password_hash: authorPw, role: UserRole.AUTHOR, is_active: true, emailVerified: new Date() } });
  const authors = [admin, editor, a1, a2, a3, a4, a5];

  // Reader accounts for comments
  const r1 = await prisma.user.upsert({ where: { email: "reader1@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() }, create: { name: "सुरेश केसी", email: "reader1@gorkhali.com", password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() } });
  const r2 = await prisma.user.upsert({ where: { email: "reader2@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() }, create: { name: "मीना राई", email: "reader2@gorkhali.com", password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() } });
  const r3 = await prisma.user.upsert({ where: { email: "reader3@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() }, create: { name: "दिपेन्द्र खड्का", email: "reader3@gorkhali.com", password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() } });
  const r4 = await prisma.user.upsert({ where: { email: "reader4@gorkhali.com" }, update: { password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() }, create: { name: "अनिता लामा", email: "reader4@gorkhali.com", password_hash: authorPw, role: UserRole.READER, is_active: true, emailVerified: new Date() } });
  ...
  // ─── Quick Links ("Today's Tools") ────────────────────
  const quickLinks = [
    {
      slug: "patro", href: "/patro",
      title_ne: "पात्रो", title_en: "Patro",
      description_ne: "नेपाली पात्रो र मिति", description_en: "Nepali calendar & dates",
      icon_key: "CalendarDays", accent_color: "#c62828", sort_order: 10,
    },
    {
      slug: "rashifal", href: "/rashifal",
      title_ne: "राशिफल", title_en: "Horoscope",
      description_ne: "आजको राशिफल", description_en: "Today's horoscope",
      icon_key: "Sparkles", accent_color: "#6a1b9a", sort_order: 20,
    },
    {
      slug: "share-market", href: "/share-market",
      title_ne: "शेयर बजार", title_en: "Share Market",
      description_ne: "नेप्से परिसूचक र शेयर भाव", description_en: "NEPSE index & quotes",
      icon_key: "ChartNoAxesCombined", accent_color: "#07579b", sort_order: 30,
    },
    {
      slug: "finance", href: "/finance",
      title_ne: "वित्त", title_en: "Finance",
      description_ne: "विदेशी मुद्रा र दर", description_en: "Exchange rates & finance",
      icon_key: "Landmark", accent_color: "#2e7d32", sort_order: 40,
    },
    {
      slug: "gold-silver", href: "/patro/gold-silver",
      title_ne: "सुन-चाँदी", title_en: "Gold & Silver",
      description_ne: "आजको भाउ", description_en: "Today's price",
      icon_key: "Coins", accent_color: "#b45309", sort_order: 50,
    },
    {
      slug: "weather", href: "/#weather",
      title_ne: "मौसम", title_en: "Weather",
      description_ne: "ताजा मौसम अपडेट", description_en: "Latest weather",
      icon_key: "CloudSun", accent_color: "#00838f", sort_order: 60,
    },
  ];
