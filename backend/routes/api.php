...
Route::get('/v1/pages/{slug}', [EditorialController::class, 'page'])->middleware('throttle:reads');
Route::get('/v1/menus/{location?}', [EditorialController::class, 'menus'])->middleware('throttle:reads');
Route::get('/v1/homepage-sections', [EditorialController::class, 'homepageSections'])->middleware('throttle:reads');
Route::get('/v1/live-blogs', [EditorialController::class, 'liveBlogs'])->middleware('throttle:reads');
Route::get('/v1/live-blogs/{slug}', [EditorialController::class, 'liveBlog'])->middleware('throttle:reads');
...
Route::get('/v1/galleries/slug/{slug}', [GalleryController::class, 'showBySlug'])->middleware('throttle:reads');
...
Route::get('/v1/reels/slug/{slug}', [ReelController::class, 'showBySlug'])->middleware('throttle:reads');
