...
export const metadata: Metadata = {
  ...
  description:
    "Gorkhali Khabarको सेवा सर्तहरू - Terms of Service",
};
  ...
  return (
    <>
      ...
      <main className="public-page-shell mx-auto max-w-4xl px-4 py-8">
        <PublicPageHeader title="सेवा सर्तहरू" eyebrow="Terms" description={`${siteNameNe} प्रयोग गर्दा लागू हुने नियम र जिम्मेवारीहरू।`} breadcrumbs={[{ label: "गृहपृष्ठ", href: "/" }, { label: "सेवा सर्तहरू" }]} />

        <article className="document-prose prose max-w-none">
          {/* Nepali */}
          <section className="mb-12">
            <h2 className="sr-only">सेवा सर्तहरू</h2>
          ...
          <section className="border-t border-border pt-8">
            <h2 className="text-3xl font-bold mb-6" style={{ fontFamily: "var(--font-nepali-serif)" }}>Terms of Service</h2>
            <p className="text-sm text-muted mb-4">
