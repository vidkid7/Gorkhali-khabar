...
export default function ProfilePage() {
  ...
  return (
    <>
      <Header />
      <main className="mx-auto max-w-7xl px-4 py-6">
        <PublicPageHeader title={t("common.profile")} eyebrow="Account" description={t("common.bookmarks")} breadcrumbs={[{ label: t("common.home"), href: "/" }, { label: t("common.profile") }]} />

        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          {/* Sidebar - User info & preferences */}
          <aside className="lg:col-span-1">
            <div className="utility-panel p-6 space-y-6">
              {/* Avatar & name */}
          ...
          <section className="lg:col-span-3">
            <h2 className="mb-6 text-2xl font-bold" style={{ fontFamily: "var(--font-nepali-serif)" }}>
              {t("common.bookmarks")}
            </h2>
            ...
            {loading ? (
              ...
              <div className="utility-panel py-12 text-center">
