...
export default function ForgotPasswordPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await laravelApi.post("/api/v1/auth/forgot-password", { email });
      setMessage(language === "ne" ? "यदि इमेल दर्ता छ भने, लिंक पठाइनेछ" : "If the email is registered, a reset link will be sent.");
    } catch (forgotError) {
      setError(forgotError instanceof LaravelApiError ? forgotError.message : t("common.error"));
