...
export default function ResetPasswordPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await laravelApi.post("/api/v1/auth/reset-password", { token, password });
      setMessage(language === "ne" ? "पासवर्ड रिसेट भयो" : "Password reset successfully.");
    } catch (resetError) {
      setError(resetError instanceof LaravelApiError ? resetError.message : t("common.error"));
