...
import { ArrowLeftRight, Coins, Lightbulb } from "lucide-react";
    ...
    <>
      ...
      <div style={{ background: "var(--background)", minHeight: "100vh" }}>
        <div className="mx-auto max-w-7xl px-4 py-8 space-y-8">
          <PublicPageHeader title={language === "ne" ? "वित्तीय बजार" : "Financial Market"} eyebrow="Finance" description={language === "ne" ? "नेपाल राष्ट्र बैंकको विदेशी विनिमय दर, सुन-चाँदीको मूल्य र बजार जानकारी" : "Nepal Rastra Bank forex rates, gold and silver prices, and market information."} countLabel={lastUpdate ? `${language === "ne" ? "अन्तिम अपडेट" : "Last updated"}: ${lastUpdate}` : undefined} breadcrumbs={[{ label: language === "ne" ? "गृहपृष्ठ" : "Home", href: "/" }, { label: language === "ne" ? "वित्तीय बजार" : "Finance" }]} />
          {loading ? (
            ...
            <>
              ...
              <div className="utility-panel overflow-hidden">
                <div className="border-b border-border px-6 py-4 text-white"
              ...
              {goldSilver && (
                <div id="gold" className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Gold */}
                  <div className="utility-panel overflow-hidden">
                    <div className="border-b border-border px-6 py-4" style={{ background: "var(--surface-alt)" }}>
                      <h2 className="text-lg font-bold flex items-center gap-2" style={{ fontFamily: "var(--font-nepali-serif)" }}>
