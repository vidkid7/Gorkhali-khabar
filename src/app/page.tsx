...
async function SidebarSection() {
  ...
  return (
    <aside className="space-y-6">
      ...
      <SidebarListClient
        icon="comments"
        titleKey="article.mostCommented"
        articles={mostCommented.map((a) => ({
          id: a.id, slug: a.slug, title: a.title, title_en: a.title_en,
          view_count: a.view_count, comment_count: a.comment_count, category: a.category,
        }))}
      />
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <main className="public-home public-page-shell mx-auto w-full max-w-7xl min-w-0 px-3 sm:px-4 py-5 sm:py-8 space-y-10 sm:space-y-14 pb-6 sm:pb-10">
        {/* Hero */}
        <section className="editorial-band editorial-band--lead"><Suspense fallback={<HeroSkeleton />}><HeroSection /></Suspense></section>

        {/* Daily Brief */}
        <section id="latest-news" className="editorial-band"><Suspense fallback={<SectionSkeleton />}><DailyBriefSection /></Suspense></section>

        {/* Quick Links */}
        <section className="editorial-band"><QuickLinks /></section>

        {/* Reels Carousel */}
        <section className="editorial-band editorial-band--media"><Suspense fallback={<div className="h-72 bg-surface rounded-xl animate-pulse" />}><ReelsSectionServer /></Suspense></section>

        {/* News + Sidebar */}
        <section className="editorial-band grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <section className="editorial-band editorial-band--tint"><Suspense fallback={<div className="h-80 bg-surface rounded-xl animate-pulse" />}><ProvincialNewsSection /></Suspense></section>

        {/* Editor's Pick */}
        <section className="editorial-band editorial-band--tint"><Suspense fallback={<SectionSkeleton />}><EditorsPickSection /></Suspense></section>
