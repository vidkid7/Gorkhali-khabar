  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8" style={{ background: "var(--background)", minHeight: "100vh" }}>
        <PublicPageHeader title={mn("नेपाली पात्रो", "Nepali Calendar (Patro)")} eyebrow="Bikram Sambat" description={mn("विक्रम सम्वत् — बिशेष दिन, तिथि र पर्वहरू", "Bikram Sambat dates, tithis and festivals")} breadcrumbs={[{ label: mn("गृहपृष्ठ", "Home"), href: "/" }, { label: mn("पात्रो", "Patro") }]} />
        ...
        {mounted && todayBSDate && todayAD && (
          <div className="mb-6 overflow-hidden border-l-4 border-primary bg-ink p-6 text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Calendar Grid */}
          <div className="utility-panel lg:col-span-2 overflow-hidden"
              ...
              {Array.from({ length: daysInMonth }, (_, i) => {
                ...
                return (
                  <button key={day}
                    ...
                    className="relative flex min-h-[64px] flex-col items-center rounded-[4px] p-1 sm:min-h-[72px] sm:p-1.5 transition-colors"
                    style={{
