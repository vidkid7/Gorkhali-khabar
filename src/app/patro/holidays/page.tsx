  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8" style={{ minHeight: "100vh" }}>
        <PublicPageHeader title={mn("सार्वजनिक बिदाहरू", "Public Holidays")} eyebrow="Calendar" description={mn("बि.सं. र सार्वजनिक बिदाहरूको सूची", "Browse public holidays by Bikram Sambat year")} countLabel={mn(`बि.सं. ${toNepaliNums(year)} — ${toNepaliNums(publicCount)} सार्वजनिक बिदाहरू`, `BS ${year} — ${publicCount} public holidays`)} breadcrumbs={[{ label: mn("गृहपृष्ठ", "Home"), href: "/" }, { label: mn("बिदाहरू", "Holidays") }]} />
        ...
        <div className="space-y-6">
          {Array.from({ length: 12 }, (_, i) => i + 1).map(month => {
            ...
            return (
              <div key={month} className="utility-panel overflow-hidden"
