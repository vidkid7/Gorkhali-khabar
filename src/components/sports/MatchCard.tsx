...
const statusConfig = {
  ...
  COMPLETED: { label: "COMPLETED", bg: "#15803d", textColor: "#fff", pulse: false },
...
export function MatchCard({
  ...
  return (
    <div
      className="utility-panel space-y-3 p-4"
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          className={`inline-flex items-center gap-1 rounded-[4px] border px-2 py-0.5 text-xs font-bold ${cfg.pulse ? "animate-pulse" : ""}`}
